...
public class TodoGoConstants {
    ...
    public static final String USER_FEEDBACK_PAGE = "user/feedback_page";
    ...
    public static final String ADMIN_USERS_LIST = "admin/users_list";
    ...
    public static final String USER_PASSWORDS_PAGE = "user/passwords_page";
